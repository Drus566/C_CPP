...
// предусловие: pq указывает на ранее инициализированную очередь
// постусловние: возвращает количество элементов в очереди
int QueueItemCount(const Queue * pq);

// операция: добавление элемента в конец очереди
// предусловие: pq указывает на ранее инициализированную очередь
// 							элемент должен быть помещен в конец очереди
// постусловие: если очередь не пуста, элемент помещается в конец очереди	и функция возвращает True;
// 							в противном случае остается незименной;
...
// 							если операция опустошает очередь, очередь переустанавливается в пустое состояние
// 							если очередь пуста с самого начала, она остается неизменной, и фнукция возвращает False
