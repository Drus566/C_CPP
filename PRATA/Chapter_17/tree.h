...
// предусловия: ptree указывает на дерево
// постусловия: функция возвращает true, если дерево пустое и false - в противном случае
bool TreeIsEmpty(const Tree * ptree);

// операция: определение, является ли дерево полным
// предусловия: ptree указывает на дерево
// постусловия: функция возвращает true, если дерево полное и false в противном случае
...
// постусловия: если возможно, функция добавляет элемент к дереву и возвращает true;
...
//							ptree - указывает на инициализированное дерево
// постусловия: если возможно, функция удаляет элемент из дерева и возвращает true; в противном случае функция возвращает false
...
// постусловия: функция, указанная с помощью pfun, выполняется один раз для каждого элемента в дереве
